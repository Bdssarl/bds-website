...
namespace bds_site_web_version2_.Migrations
{
    ...
    [Migration("20240106120212_removeSommeAttributes")]
    partial class removeSommeAttributes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bds_site_web.Models.Consulter", b =>
                {
                    b.Property<string>("EbooksIdEbook")
                        .HasColumnType("varchar(25)");
                    ...
                    b.HasKey("EbooksIdEbook", "UsersId");
            ...
            modelBuilder.Entity("Bds_site_web.Models.DemandeEmploi", b =>
                {
                    b.Property<string>("IdEmploiNavigationIdEmploi")
                        .HasColumnType("varchar(25)");
                    ...
                    b.HasKey("IdEmploiNavigationIdEmploi", "UsersId");
            ...
            modelBuilder.Entity("Bds_site_web.Models.DemandeStage", b =>
                {
                    ...
                    b.HasKey("StagesIdStage", "UsersId");
            ...
            modelBuilder.Entity("Bds_site_web.Models.Newsletter", b =>
                {
                    b.Property<string>("IdNewsletter")
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)")
            ...
            modelBuilder.Entity("Bds_site_web.Models.Page", b =>
                {
                    b.Property<string>("IdPage")
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
                    ...
                    b.Property<string>("LibellePage")
                        .IsRequired()
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
                        .HasColumnName("libelle_page");

                    b.HasKey("IdPage", "IdActualite")
                        .HasName("PRIMARY");

                    b.HasIndex(new[] { "IdActualite" }, "fk_1_page");

                    b.ToTable("page_", (string)null);
                });
            ...
            modelBuilder.Entity("Bds_site_web.Models.PostulerAnnonceRecrutement", b =>
                {
                    b.Property<string>("AnnonceRecrutementsIdAnnonceRecrutement")
                        .HasColumnType("varchar(25)");
                    ...
                    b.HasKey("AnnonceRecrutementsIdAnnonceRecrutement", "UsersId");
            ...
            modelBuilder.Entity("Bds_site_web.Models.ProjetAVenir", b =>
                {
                    b.Property<string>("IdProjetAVenir")
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
            ...
            modelBuilder.Entity("Bds_site_web.Models.ProjetEnCour", b =>
                {
                    b.Property<string>("IdProjetEnCours")
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
            ...
            modelBuilder.Entity("Bds_site_web.Models.ProjetRealise", b =>
                {
                    b.Property<string>("IdProjetRealise")
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
            ...
            modelBuilder.Entity("Bds_site_web.Models.Stage", b =>
                {
                    b.Property<string>("IdStage")
                        .HasMaxLength(25)
                        .HasColumnType("varchar(25)")
                        .HasColumnName("id_Stage");

                    b.Property<string>("DemandeStageStagesIdStage")
                        .HasColumnType("varchar(25)");
                    ...
                    b.HasIndex("DemandeStageStagesIdStage", "DemandeStageUsersId");
            ...
            modelBuilder.Entity("Bds_site_web.Models.Telecharger", b =>
                {
                    ...
                    b.Property<string>("IdTelechargement")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Bds_site_web.Models.Temoignage", b =>
                {
                    b.Property<string>("IdTemoignage")
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)")
            ...
            modelBuilder.Entity("Bds_site_web.Models.UserToNewsLetter", b =>
                {
                    b.Property<string>("NewslettersIdNewsletter")
                        .HasColumnType("varchar(20)");

                    b.Property<string>("UserNewslettersEmailUser")
                        .HasColumnType("varchar(25)");

                    b.HasKey("NewslettersIdNewsletter", "UserNewslettersEmailUser");
            ...
            modelBuilder.Entity("Bds_site_web.Models.DemandeEmploi", b =>
                {
                    b.HasOne("Bds_site_web.Models.Emploi", "IdEmploiNavigation")
                        .WithMany()
                        .HasForeignKey("IdEmploiNavigationIdEmploi")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bds_site_web.Models.Page", b =>
                {
                    b.HasOne("Bds_site_web.Models.Actualite", "IdActualiteNavigation")
                        .WithMany("Pages")
                    ...
                    b.Navigation("IdActualiteNavigation");
                });
            ...
            modelBuilder.Entity("Bds_site_web.Models.PostulerAnnonceRecrutement", b =>
                {
                    b.HasOne("Bds_site_web.Models.AnnonceRecrutement", null)
                        .WithMany()
                        .HasForeignKey("AnnonceRecrutementsIdAnnonceRecrutement")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bds_site_web.Models.Stage", b =>
                {
                    b.HasOne("Bds_site_web.Models.DemandeStage", null)
                        .WithMany("Stages")
                        .HasForeignKey("DemandeStageStagesIdStage", "DemandeStageUsersId");
                });
            ...
            modelBuilder.Entity("Bds_site_web.Models.UserToNewsLetter", b =>
                {
                    b.HasOne("Bds_site_web.Models.Newsletter", null)
                        .WithMany()
                        .HasForeignKey("NewslettersIdNewsletter")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
